...
public class MediaPlaybackService extends Service implements Playable {
    ...
    private BroadcastReceiver mNotificationBroadcast = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            String action = intent.getExtras().getString(NotificationActionReceiver.NOTIFICATION_ACTION_NAME);
            if(action != null) {
                switch (action) {
    ...
    public void onCreate() {
        ...
        registerReceiver(mNotificationBroadcast, new IntentFilter(NotificationActionReceiver.BROADCAST_ACTION));
    }
    ...
    private NotificationCompat.Builder getNotificationBuilder() {
        ...
        //Previous button
        Intent intentPrev = new Intent(getApplicationContext(), NotificationActionReceiver.class)
        ...
        //Next button
        Intent intentNext = new Intent(getApplicationContext(), NotificationActionReceiver.class)
        ...
        Intent intentClose = new Intent(getApplicationContext(), NotificationActionReceiver.class)
                .setAction(ACTION_CLOSE);
        PendingIntent pendingIntentClose = PendingIntent.getBroadcast(getApplicationContext(),
                MEDIA_NOTIFICATION_ID, intentClose, PendingIntent.FLAG_UPDATE_CURRENT);
        int nextImage = R.drawable.ic_fwd_dark;

        int close = R.drawable.ic_close;


        //Play button
        int playImage;
        Intent intentPlay = new Intent(getApplicationContext(), NotificationActionReceiver.class)
        ...
        NotificationCompat.Builder notifyBuilder =
                new NotificationCompat.Builder(this, NOTIFI_CHANNEL_ID)
                        ...
                        .addAction(prevImage, getString(R.string.previous_notification_label), pendingIntentPrev)
                        .addAction(playImage, getString(R.string.play_notification_label), pendingIntentPlay)
                        .addAction(nextImage, getString(R.string.next_notification_label), pendingIntentNext)
                        .addAction(close, getString(R.string.close_notification_label), pendingIntentClose)
    ...
    public ArrayList<Song> getmListAllSong() {
        return mListAllSong;
    }
}
