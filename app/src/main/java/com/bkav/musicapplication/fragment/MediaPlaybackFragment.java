...
public class MediaPlaybackFragment extends Fragment
    ...
    //Bkav Thanhnch: Dang khai bao nhieu bien nay-> chi nen dung  bien trong class Constant?
    ...
    //Tuantqd: Se bo sung chuc nang an like (dislike)
...
//          message.arg1 = mMediaPlaybackService.getmMediaPlayer().getCurrentPosition();
     ...
     * (Copy: KhoaPham) - Giu lai tham khao
     */
