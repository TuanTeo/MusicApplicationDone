...
public class BaseFragment extends Fragment {
    ...
    public void initView(View view) {
        ...
        mPlayMediaImageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mMainActivity.getMediaService().getmMediaPlayer().isPlaying()) {
                    mMainActivity.getMediaService().pauseMedia();
                    mPlayMediaImageButton.setImageResource(R.drawable.ic_media_play_light);
                } else {
                    mMainActivity.getMediaService().resumeMedia();
    ...
    public void upDateSmallPlayingRelativeLayout(ArrayList<Song> mListSongAdapter,
        ...
        if (mMainActivity.getMediaService().getmMediaPlayer() != null) {
            Song song =  mMainActivity.getMediaService().getCurrentSong();
